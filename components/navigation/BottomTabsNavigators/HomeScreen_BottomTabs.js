import { View, Text, Image, Touchable, TouchableOpacity, Platform } from "react-native";
      ...
      <BottomTabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            ...
            // />
            <Image
                source={focused ? SocialsPageData.BottomNavigation.HomeScreenIcon.Active : SocialsPageData.BottomNavigation.HomeScreenIcon.Inactive}
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
              ...
              <Image
                ...
                style={{ height: scale(55), width: scale(55), marginTop:scale(-30)}}
              />
